...
pub fn build_status_event_payload(
    ...
    StatusEventPayload {
        ...
        mutation_reachable_target_total: health.mutation_reachable_target_total,
        mutation_unreachable_target_total: health.mutation_unreachable_target_total,
        mutation_not_applicable_target_total: health.mutation_not_applicable_target_total,
...
mod tests {
    ...
    fn status_payload_keeps_action_shape() {
        let payload = super::StatusEventPayload {
            ...
            mutation_reachable_target_total: 0,
            mutation_unreachable_target_total: 0,
            mutation_not_applicable_target_total: 0,
