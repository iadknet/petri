...
mod tests {
    ...
    fn random_input_reference_covers_all_categories() {
        ...
        // Still 8: extended perception variants (AreaFoodSummary, etc.) are match-arm-covered
        // above but not yet generated by random_input_reference (pool expands in Step 5).
        assert_eq!(
            categories.len(),
            8,
