---
description: Mental-model reset for Rust. Use when writing or reviewing Rust code to shift from "it compiles" to "thinks in Rust." Triggers on Rust code review, "is this idiomatic", borrow-checker errors, API design, domain modeling, ownership, lifetimes, errors, traits, async/Tokio, unsafe, serde, FFI, tests, performance, Cargo structure, .rs files, Cargo.toml, rustc diagnostics, clippy findings, Result/Option, thiserror vs anyhow, newtype, typestate, enum vs trait, dyn Trait, Send/Sync, Pin, Miri, PyO3, napi-rs, cxx, UniFFI, wasm-bindgen, serde attributes, or feature unification.
metadata:
    github-path: rust
    github-ref: 516dee7a422b90937b2958d11c03694154ab9c09
    github-repo: https://github.com/joshuadavidthomas/agent-skills
    github-tree-sha: ada18180bad9f221f3a9aeddbdb0229d25e5a8f7
name: rust
---
# Thinking in Rust
