...
export function useMeshWorkspaceController(): MeshWorkspaceController {
	...
	const [selectedSearchNodeId, setSelectedSearchNodeId] = useState<number | null>(null);
	const [viewportCommand, setViewportCommand] = useState<MeshViewportCommand | null>(null);
