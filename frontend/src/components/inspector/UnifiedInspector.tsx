...
import { useInspectorSampler } from "./hooks/useInspectorSampler.ts";
import { useMeshDerivation } from "./hooks/useMeshDerivation.ts";
import { MeshCanvas } from "./mesh/MeshCanvas.tsx";
import { MeshControls } from "./mesh/MeshControls.tsx";
import { deriveTraceFocus } from "./mesh/traceFocus.ts";
...
export function UnifiedInspector({
	...
	// ── Sampler domain ──────────────────────────────────────────────────
	const sampler = useInspectorSampler(creatureId);
