...
| `CP-1 Runtime Kernel` | `docs/plans/2026-02-13-creature-brain-mesh-stage-2-backends-energy.md` | complete | `CP-0` complete | Queue + energy + backend integration tests green |
