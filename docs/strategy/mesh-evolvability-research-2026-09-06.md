...
C3 (persistent routing position) after T11.F10; C4 (tags) contingent on C2 readings; C5 (cost) to T03.F08; A7 and A8 to T11.F13; C6, C7 rejected; C8 to T08; C10 a sequencing note for T02.
