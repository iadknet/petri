...
- [ ] **T04.F02 — Local Dispersal and Reproduction Range** — Depends on: None
  - Goal: Offspring are born nearby. Reproduction places young close to the parent and dispersal is limited, so populations can differentiate by place.
