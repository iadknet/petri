...
- [ ] **T01.F13 — Evolutionary Activity and Shadow-Model Baseline** — Depends on: T01.F12
  - Goal: Optional supplement to the go/no-go. Is selection doing anything at all, measured as activity above a neutral shadow run with the same births and deaths?
