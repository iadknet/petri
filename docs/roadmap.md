...
- Baseline persistence measured 2026-09-04 at commit d4d5005a by T01.F11, with production defaults over seeds 11/22/33 and 2,000 ticks; the four regenerable sweep reports are in `docs/progress/sweeps/t01-f11/`. The default 1600-by-1600 world with 10,000 founders persists on every seed: it peaks near 35,000 to 36,000 creatures by tick 150, falls to a trough of 4,310 to 5,003 around tick 900, and recovers to 6,790 to 7,291 by tick 2,000. Persistence below that size is seed-dependent rather than uniform extinction, superseding the 2026-09-03 `v3-cli run` finding that every world at or below 512-by-512 dies by tick 300: 128-by-128 went extinct on all three seeds by tick 175, one 256-by-256 seed survived as a single creature, and one 512-by-512 seed peaked at 22,592 and was still falling at 9,206 by tick 2,000. Throughput remains the 2026-09-03 measurement at commit 98f09322 — the default world ran at about 3 ticks per second single-threaded — until T10.F09 re-measures it. The 20-tick viability gate does not detect any of this.
