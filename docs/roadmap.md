...
- Baseline persistence measured 2026-09-04 at commit d4d5005a by T01.F11 with production defaults, seeds 11/22/33 and 2,000 ticks, in the four regenerable sweep reports under `docs/progress/sweeps/t01-f11/`: the default 1600-by-1600 world with 10,000 founders persists on every seed, peaking near 35,000 to 36,000 creatures by tick 150, falling to a trough of 4,310 to 5,003 around tick 900, and recovering to 6,790 to 7,291 by tick 2,000. Persistence below that size is seed-dependent rather than uniform extinction, superseding the 2026-09-03 `v3-cli run` finding at commit 98f09322 that every world at or below 512-by-512 dies by tick 300: 128-by-128 went extinct on all three seeds by tick 175, one 256-by-256 seed survived as a single creature, and one 512-by-512 seed peaked at 22,592 and was still falling at 9,206 by tick 2,000. T10.F09 re-measured throughput on 2026-09-04 in the eight reports under `docs/progress/sweeps/t10-f09/`: the default world runs at 9.53 ticks per second on one thread (34,300 ticks and 2.74 million births per wall-clock hour, 93,456 creature-ticks per second) and 10.54 ticks per second on all eight logical cores, superseding the 2026-09-03 figure of about 3 ticks per second. Those runs also showed the simulation is not reproducible across processes at 512-by-512 and above, so the seed-level counts above are one draw rather than a fixed fact until T10.F11 restores reproducibility and regenerates them. The 20-tick viability gate does not detect any of this.
